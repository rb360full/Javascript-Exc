...
const generateBtm = document.querySelector(".btn.btn-primary");
...
function generateText() {
  ...
  for (let i = 0; i < amountElem.value; i++) {
    ...
    resultElem.innerHTML += dummyText[randomIndex] + "<br><br>";
  }
}

generateBtm.addEventListener("click", generateText);
